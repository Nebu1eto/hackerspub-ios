        ...
        public struct Edge: HackersPub.SelectionSet {
          ...
          public struct Node: HackersPub.SelectionSet {
            ...
            public struct SharedPost: HackersPub.SelectionSet {
              ...
              /// SearchPost.Edge.Node.SharedPost.QuotedPost
              ///
              /// Parent Type: `Post`
              public struct QuotedPost: HackersPub.SelectionSet {
                ...
                @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                  SearchPostQuery.Data.SearchPost.Edge.Node.SharedPost.QuotedPost.self
                ] }
                ...
                /// SearchPost.Edge.Node.SharedPost.QuotedPost.Actor
                ///
                /// Parent Type: `Actor`
                public struct Actor: HackersPub.SelectionSet {
                  @_spi(Unsafe) public let __data: DataDict
                  ...
                  @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                    SearchPostQuery.Data.SearchPost.Edge.Node.SharedPost.QuotedPost.Actor.self
                  ] }
                ...
                /// SearchPost.Edge.Node.SharedPost.QuotedPost.Medium
                ///
                /// Parent Type: `PostMedium`
                public struct Medium: HackersPub.SelectionSet {
                  @_spi(Unsafe) public let __data: DataDict
                  ...
                  @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                    SearchPostQuery.Data.SearchPost.Edge.Node.SharedPost.QuotedPost.Medium.self
                  ] }

          ...
          public struct Node: HackersPub.SelectionSet {
            ...
            public struct SharedPost: HackersPub.SelectionSet {
              ...
              public struct QuotedPost: HackersPub.SelectionSet {
                ...
                @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                  LocalTimelineQuery.Data.PublicTimeline.Edge.Node.SharedPost.QuotedPost.self
                ] }
                ...
                public struct Actor: HackersPub.SelectionSet {
                  ...
                  @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                    LocalTimelineQuery.Data.PublicTimeline.Edge.Node.SharedPost.QuotedPost.Actor.self
                  ] }
                ...
                public struct Medium: HackersPub.SelectionSet {
                  ...
                  @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                    LocalTimelineQuery.Data.PublicTimeline.Edge.Node.SharedPost.QuotedPost.Medium.self
                  ] }
